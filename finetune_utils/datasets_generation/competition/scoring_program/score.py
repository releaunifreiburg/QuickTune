...
try:
    from src.datasets_creation.competition.scoring_program.libscores import _HERE
    from src.datasets_creation.competition.scoring_program.libscores import get_logger
    from src.datasets_creation.competition.scoring_program.libscores import ls
    from src.datasets_creation.competition.scoring_program.libscores import mvmean
    from src.datasets_creation.competition.scoring_program.libscores import read_array
    from src.datasets_creation.competition.scoring_program.libscores import sp
    from src.datasets_creation.competition.scoring_program.libscores import tiedrank
except ImportError:
