...
def load_autodl_dataset(dataset_dir, verbose=False):
    ...
    from src.datasets_generation.competition.ingestion_program import data_io
    from src.datasets_generation.competition.ingestion_program.dataset import AutoDLDataset  # THE class of AutoDL datasets
    from src.datasets_generation.competition.scoring_program.score import get_solution
    ...
    for n in range(n_augmentations):
        ...
        for dataset_name, dataset_dir in zip(dataset_names, dataset_dirs):
            ...
            if h == -1 or w == -1:
                ...
                dataset_id = str(n) + '-' + dataset_name
                per_dataset_size_dict[dataset_id] = {
                    "min":  _min,
                    "max":  _max,
                    "mean": _mean
                    }
...
if __name__ == '__main__':
    ...
    datasets_main_dir = '/work/dlclarge1/pineda-datasets_generation-data/datasets/'
