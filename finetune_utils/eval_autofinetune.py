...
def eval_finetune_conf(conf, task_info, budget=1, experiment="test",
    ...
    cotuning_reg = conf["cotuning_reg"]
    ...
    return float(eval_top1), float(eval_time)
