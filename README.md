...
`
cd hpo/optimizers/quick_tune
--experiment_id --aft_set micro --hidden_dim 32 --output_dim 32 --learning_rate 0.0001 --meta_learning_rate 0.0001 --meta_train 1 --use_encoders_for_model 1 --cost_aware 1 --budget_limit 3600
